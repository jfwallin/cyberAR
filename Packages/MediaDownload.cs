...
public class MediaDownload : MonoBehaviour
{
    ...
    public string manifestEndpoint = null;
    public string labsEndpoint = null;
    ...
    void Start()
    {
        ...
        string json = null; 
        StartCoroutine(DownloadManifest(manifestEndpoint, json));
        ...
        foreach(LabInfo lab in manifest.labs)
        {
            ...
            StartCoroutine(DownloadManifest(labsEndpoint + lab.lab_id, json));
